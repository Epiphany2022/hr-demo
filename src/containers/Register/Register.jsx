    ...
    <div className={classes.MainContainer}>
      ...
      <div className={classes.SecondaryContainer}>
        ...
        <motion.div
          ...
          className={[
            isSubmitted ? classes.FormContainerSubmit : classes.FormContainer,
          ]}
        >
          <form
            autoComplete="off"
          ...
          >
            ...
            <div className={classes.InputBox}>
              ...
              <i
                ...
                className={
                  passwordShownColor === "inActive"
                    ? classes.EyeIcons
                    : [classes.EyeIcons, classes.ActivePassword].join(" ")
                }
              >
                {eye}
              </i>
            ...
            <div className={classes.LinkContainer}>
              <p>
                Already registered ?{" "}
                <Link className={classes.LinkSeg} to="/login">
                  Login
                </Link>{" "}
              </p>
            </div>
          ...
          {error ? (
            <div className={classes.ErrorMessageEmail}>{error}</div>
          ) : null}
        </motion.div>
      </div>
      <div
        className={[
          isSubmitted
            ...
            : classes.SuccessContainerHidden,
        ]}
      >
        Form Submitted
      </div>
